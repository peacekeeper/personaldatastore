...
public class AccountRootContentPane extends ContentPane implements XdiGraphListener {
	...
	public void setContextAndSubjectXri(XdiContext context, XRI3Segment subjectXri) {
		...
		this.equivalenceAddress = new XRI3("" + this.subjectXri + "/" + DictionaryConstants.XRI_EQUIVALENCE);
		this.inheritanceAddress = new XRI3("" + this.subjectXri + "/" + DictionaryConstants.XRI_INHERITANCE);
