...
public class PdsSubjectPredicateLiteralResourceHandler extends AbstractResourceHandler {

	private PdsConnection pdsConnection;

	public PdsSubjectPredicateLiteralResourceHandler(Message message, Subject operationSubject, Predicate operationPredicate, Literal operationLiteral, PdsConnection pdsConnection) {
