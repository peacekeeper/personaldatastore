...
public class GrsXriSignUpPanel extends Panel {
	...
	private void onActionPerformed(ActionEvent e) {
		...
		GrsXriSignUpWindowPane grsXriSignUpWindowPane = new GrsXriSignUpWindowPane();
		grsXriSignUpWindowPane.setGrsXriSignUpMethod(this.grsXriSignUpMethod);

		MainWindow.findMainContentPane(this).add(grsXriSignUpWindowPane);
	}
	...
	private void initComponents() {
		...
		label1.setText("Example: =yourname");
		row1.add(label1);
	}
}
